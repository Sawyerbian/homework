...
def make_sheet(name):
  ...
  for i in range(1, 26):
    for j in range(1, 5):
      if i % 4 == 1:
        ...
        while(((a % 10 + b % 10) // 10 < 1) or (((a + b) % 10 + c % 10) // 10 < 1)):
          a = random.randint(5, 20)
          b = random.randint(8, 15)
          c = random.randint(1, 20)
          if ((a % 10 + b % 10) // 10 >= 1) and (((a + b) % 10 + c % 10) // 10 >= 1):
            break            
        ws.cell(row=i+1, column=j).value = f"{a} + {b} + {c} =   "
        ...
        b = random.randint(8, 15)
        c = random.randint(1, 20)
        while(((a % 10 + b % 10) // 10 < 1) or ((a + b) < c) or ((a + b)%10 - c%10 < 1)):
          a = random.randint(5, 20)
          b = random.randint(8, 15)
          c = random.randint(1, 20)
          if ((a % 10 + b % 10) // 10 >= 1) and ((a + b) >= c) and ((a + b)%10 - c%10 >= 1):
            break          
        ws.cell(row=i+1, column=j).value = f"{a} + {b} - {c} =   "
        ws.cell(row=i+1, column=j).font = fontStyle
        ...
        while(a % 10 - b % 10) >= 0 or ((a - b -c) < 0):
          a = random.randint(11, 20)
          b = random.randint(5, 20)
          c = random.randint(5, 20)
          if (a % 10 - b % 10) < 0 and ((a - b -c) >= 0):      
            break
        print(a, b, c)
        ws.cell(row=i+1, column=j).value = f"{a} - {b} - {c} =   "
        ws.cell(row=i+1, column=j).font = fontStyle
  ...
  for i in range(1, 5):
    if i % 2 == 1:
      ...
      ws.cell(row=27, column=i).font = fontStyle
